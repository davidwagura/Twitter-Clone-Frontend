<template>
    ...
    <div v-if="isModalOpen" class="fixed inset-0 flex items-center justify-center z-50">
      ...
      <div class="bg-white shadow-lg rounded-lg border w-full max-w-sm p-6 relative">
        ...
        <h2 class="text-2xl font-bold text-center mb-6">Sign in to X</h2>
  
        <button class="w-full border p-4 text-black font-bold py-2 px-4 rounded-lg mb-4 flex items-center justify-center">
        ...
        <button class="w-full border text-gray-800 font-bold py-2 px-4 rounded-lg mb-4 flex items-center justify-center">
        ...
        <div class="mb-4">
          ...
          <input class="border rounded-lg w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-1 focus:ring-blue-500" v-model="data.email" type="text" placeholder="Phone, email, or username" required>
        
        </div>
  
        <div class="flex items-center justify-center mb-4">

          <button class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" type="submit">
