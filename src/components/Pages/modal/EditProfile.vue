  ...
  <div v-if="showModal" class="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50 z-50">
    ...
    <div class="bg-white rounded-lg shadow-lg w-full max-w-xl h-[90vh] overflow-auto p-6">
      ...
      <div class="flex">
        ...
        <button @click="closeModal" class="text-gray-600 mr-4 hover:text-gray-900">
      ...
      <form @submit.prevent="updateProfile">
        ...
        <div class="space-y-2">
          ...
          <div>
            ...
            <!-- <input type="file" @change="handleBackgroundImageChange" class="mt-1 mb-2 w-full border border-gray-300 rounded-md p-2"> -->
            ...
            <div class="relative">
              ...
              <div class="w-full h-36 bg-gray-200 rounded-md border border-gray-300 flex items-center justify-center text-gray-500">
                ...
                <div v-if="!backgroundImagePreview"> 
                  
                  <svg xmlns="http://www.w3.org/2000/svg" @change="handleBackgroundImageChange" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
          ...
          <div>
            ...
            <!-- <input type="file" @change="handleProfileImageChange" class="mt-1 mb-2 w-full border border-gray-300 rounded-md p-2"> -->
              ...
              <div class="w-24 h-24 bg-gray-200 ml-6 rounded-full border border-gray-300 flex text-gray-500">
                ...
                <div v-if="!backgroundImagePreview" class="flex items-center mx-auto justify-center"> 
                  
                  <svg xmlns="http://www.w3.org/2000/svg" @change="handleProfileImageChange" type="file" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
